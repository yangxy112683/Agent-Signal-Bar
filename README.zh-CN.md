...
<table>
  <tr>
    <td align="center"><strong>无毛玻璃</strong></td>
    <td align="center"><strong>标准毛玻璃</strong></td>
  </tr>
  <tr>
    <td><img src="docs/assets/settings-solid-zh-CN.png" alt="Agent Signal Bar 无毛玻璃设置窗口运行页" width="420"></td>
    <td><img src="docs/assets/settings-glass-zh-CN.png" alt="Agent Signal Bar 标准毛玻璃效果下的设置窗口运行页" width="420"></td>
  </tr>
</table>

两张图都是运行页的真实屏幕区域截图。左图是普通纯色设置窗口，右图是开启标准毛玻璃后的效果，可以看到桌面背景参与到窗口材质里。毛玻璃效果可以在 `通用 > 设置毛玻璃` 中开关和调整。
