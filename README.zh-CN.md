...
<p align="center">
  <img src="docs/assets/status-bar-demo.gif" alt="Agent Signal Bar 灯效演示" width="720">
</p>
...
<p align="center">
  <img src="docs/assets/settings-activity-zh-CN.png" alt="Agent Signal Bar 设置窗口运行页" width="720">
</p>

设置窗口包含运行、样式、灯效、连接、通用、关于页面，可查看 Agent 运行详情、调整状态栏样式、定制灯效、管理接入并查看应用信息。
