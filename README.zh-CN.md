...
<table>
  <tr>
    ...
    <td align="center"><strong>标准液态玻璃</strong></td>
  </tr>
  <tr>
    <td><img src="docs/assets/settings-solid-zh-CN.png" alt="Agent Signal Bar 无液态玻璃设置窗口运行页" width="420"></td>
    <td><img src="docs/assets/settings-glass-zh-CN.png" alt="Agent Signal Bar 标准液态玻璃效果下的设置窗口运行页" width="420"></td>
  </tr>
</table>

两张图都是运行页的真实屏幕区域截图。左图是普通纯色设置窗口，右图是开启标准液态玻璃后的效果，可以看到桌面背景参与到窗口材质里。液态玻璃效果默认开启，默认强度为 `减弱`，可在 `通用 > 液态玻璃效果` 中切换，并支持 `减弱 / 标准 / 增强` 三档强度。
