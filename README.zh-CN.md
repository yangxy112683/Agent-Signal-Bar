...
<p align="center">
  <a href="https://github.com/guan-ops/Agent-Signal-Bar/releases/latest"><img src="https://img.shields.io/badge/release-v1.3.3-111827.svg" alt="最新版本：v1.3.3"></a>
...
<p align="center">
  <img src="docs/assets/floating-signal-light-v1.3.0.png" alt="Agent Signal Bar 三灯全亮的桌面悬浮信号灯和正在运行的 Agent 数字角标" width="260">
</p>

悬浮信号灯可以常驻桌面，并和状态栏信号灯同步闪烁。它支持拖动、缩放、横向/竖向布局、正在运行的 Agent 数字角标，以及紧凑的当前会话信息浮层。完成、绿灯闪烁和告警状态可以分别设置提示音。
...
- 完成、绿灯闪烁和告警状态可分别选择提示音，内置新西兰红绿灯声音。
- 两种外观：经典灯牌和极简圆点。
