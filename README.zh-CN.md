...
<p align="center">
  <a href="https://github.com/guan-ops/Agent-Signal-Bar/releases/latest"><img src="https://img.shields.io/badge/release-v1.5.1-111827.svg" alt="最新版本：v1.5.1"></a>
...
悬浮信号灯可以常驻桌面，并和状态栏信号灯同步闪烁。它支持拖动、缩放、横向/竖向布局、正在运行的 Agent 数字角标、额度角标、Token 用量角标，以及紧凑的当前会话和用量浮层。完成、绿灯闪烁和告警状态可以分别设置提示音。
