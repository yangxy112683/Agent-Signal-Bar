...
<p align="center">
  <img src="docs/assets/light-effects-landscape-zh-CN.gif" alt="Agent Signal Bar 网站同款灯效预览图，由同一套灯效动画引擎生成" width="900">
</p>

这是网站同款灯效预览图，由 App 实际使用的同一套灯效动画引擎生成，集中展示主要默认灯效和可自定义灯效，并同时展示经典灯牌和极简圆点两种状态栏样式。
