...
<p align="center">
  <img src="docs/assets/settings-glass-zh-CN.png" alt="Agent Signal Bar 标准毛玻璃效果下的设置窗口运行页" width="720">
</p>

上图是开启标准毛玻璃效果后的真实运行页截图。毛玻璃效果可以在 `通用 > 设置毛玻璃` 中开关和调整；运行、样式、灯效、连接、通用、关于页面分别用于查看 Agent 运行详情、调整状态栏样式、定制灯效、管理接入并查看应用信息。
